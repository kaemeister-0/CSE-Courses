...
{
       0,    40,    40,    48,    58,    67,    78,    92,   105,   115,
     124,   132,   141,   150,   159,   169,   173,   177,   182,   191,
     203,   211,   222,   227,   234,   245,   252,   259,   266,   279,
     290,   303,   314,   325,   337,   343,   353,   361,   374,   381,
     392,   399,   410,   417,   428,   435,   446,   453,   463,   471,
     479,   490,   497,   507,   516,   520,   524,   532,   542,   551,
     560,   569
};
#endif
...
#line 192 "23341060.y"
    {
		       ...
		       node->addChild(TreeNode::createTerminalNode("integers", (yyvsp[(5) - (6)])->getname().c_str()));
...
#line 212 "23341060.y"
    {
		       ...
		       node->addChild((yyvsp[(1) - (4)])->getNode());
		       node->addChild(TreeNode::createTerminalNode("LTHIRD", "["));
		       node->addChild(TreeNode::createTerminalNode("integers", (yyvsp[(3) - (4)])->getname().c_str()));
		       node->addChild(TreeNode::createTerminalNode("RTHIRD", "]"));
		       (yyval) = new symbol_info("declaration_list", "non_terminal", node); /// WILL THERE 	
...
#line 228 "23341060.y"
    {
		       ...
		       node->addChild((yyvsp[(1) - (1)])->getNode());
		       (yyval) = new symbol_info("statements", "non_terminal", node); /// WILL THERE 
...
#line 338 "23341060.y"
    {
		       ...
		       node->addChild(TreeNode::createTerminalNode("SEMICOLON", ";"));
		       (yyval) = new symbol_info("expression_statement", "non_terminal", node); /// WILL THERE 		
	        }
    break;
...
#line 382 "23341060.y"
    {
		       ...
		       node->addChild((yyvsp[(3) - (3)])->getNode());
		       (yyval) = new symbol_info("expression", "non_terminal", node); /// WILL THERE 	
		       rootNode = node;
	   }
    break;
...
#line 393 "23341060.y"
    {
		       ...
		       node->addChild((yyvsp[(1) - (1)])->getNode());
		       (yyval) = new symbol_info("logic_expression", "non_terminal", node); /// WILL THERE 
		       rootNode = node;
	     }
    break;
...
#line 411 "23341060.y"
    {
		       ...
		       node->addChild((yyvsp[(1) - (1)])->getNode());
		       (yyval) = new symbol_info("rel_expression", "non_terminal", node); /// WILL THERE 
		       rootNode = node;
	    }
    break;
...
int main(int argc, char *argv[])
{
    ...
    yyin = fopen(argv[1], "r");
    outlog.open("23341060.txt", std::ios::trunc);
